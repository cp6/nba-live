 ...
 */
final class NBABoxScoreUsage extends NBABoxScoreFilters implements FetchableEndpoint
{
    ...
    {
        $this->data = $this->ApiCall("https://stats.nba.com/stats/boxscoreusagev3?{$this->filters}&GameID={$this->game_id}");
