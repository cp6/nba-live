 ...
 */
final class NBABoxScoreScoring extends NBABoxScoreFilters implements FetchableEndpoint
{
    ...
    {
        $this->data = $this->ApiCall("https://stats.nba.com/stats/boxscorescoringv3?{$this->filters}&GameID={$this->game_id}");
